...
cameraTrigger1.onclick = function() {
    ...
    fetch(picture)
    	...
    	.then(blobData => {
    		...
    		var subscriptionKey = ""; //Enter your API Subscription Key here
	        ...
	        .done(function(data) {
	        	...
	        	url = "http://localhost:3000/add" +'/'+naam+'/'+ff.replace(/['"]+/g, '');
  				$.ajax({
	            url: url,
...
cameraTrigger2.onclick = function() {
    ...
    fetch(picture)
    	...
    	.then(blobData => {
    		...
    		var subscriptionKey = ""; //Enter your API subscription key here again
	        ...
	        .done(function(data) {
	        	...
	        	if(typeof data[0] === 'undefined'){alert("Take a better picture!")}else{
	        	ff = (JSON.stringify(data[0].faceId));
	        	url = "http://localhost:3000/search" +'/'+naam;
  				$.ajax({
	            url: url,
