...
cameraTrigger1.onclick = function() {
    ...
    fetch(picture)
    	...
    	.then(blobData => {
    		...
    		var subscriptionKey = "d17cddc6641c4df8a072a2a59c757f48"; //Enter your API Subscription Key here
...
cameraTrigger2.onclick = function() {
    ...
    fetch(picture)
    	...
    	.then(blobData => {
    		...
    		var subscriptionKey = "d17cddc6641c4df8a072a2a59c757f48"; //Enter your API subscription key here again
